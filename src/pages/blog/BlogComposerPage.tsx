              ...
              <div className="relative rounded-xl overflow-hidden" style={{ aspectRatio: "16/9" }}>
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1">
                  ...
                  <div className="relative group/tip">
                    ...
                    <span className="pointer-events-none absolute top-full left-1/2 -translate-x-1/2 mt-1.5 whitespace-nowrap rounded-md bg-slate-800 px-2 py-1 text-xs text-white opacity-0 group-hover/tip:opacity-100 transition-opacity">Copy image</span>
                  </div>
                  {/* Copy image URL */}
                  {cj?.hero_image_url ? (
                    <div className="relative group/tip">
                      ...
                      <span className="pointer-events-none absolute top-full left-1/2 -translate-x-1/2 mt-1.5 whitespace-nowrap rounded-md bg-slate-800 px-2 py-1 text-xs text-white opacity-0 group-hover/tip:opacity-100 transition-opacity">Copy image URL</span>
                    </div>
                  ) : null}
                  {/* Download */}
                  <div className="relative group/tip">
                    ...
                    <span className="pointer-events-none absolute top-full left-1/2 -translate-x-1/2 mt-1.5 whitespace-nowrap rounded-md bg-slate-800 px-2 py-1 text-xs text-white opacity-0 group-hover/tip:opacity-100 transition-opacity">Download</span>
                  </div>
                </div>
              </div>
            </div>
