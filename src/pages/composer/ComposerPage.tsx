    ...
    <div className="h-full flex flex-col gap-0">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-white flex-shrink-0">
        <div className="flex items-center gap-4">
          <h1 className="text-lg font-bold text-slate-900">{urlPostId ? "Edit Post" : "New Post"}</h1>
        ...
        <div className="flex items-center gap-2">
          {phase === "editing" && (
            <>
              <Button variant="ghost" size="sm" onClick={() => navigator.clipboard.writeText(content)} title="Copy to clipboard">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Right panel */}
        <div className="w-80 xl:w-96 flex-shrink-0 border-l border-slate-100 bg-slate-50/50 overflow-y-auto px-5 py-6 space-y-6">
          <LinkedInPreview
            content={content}
